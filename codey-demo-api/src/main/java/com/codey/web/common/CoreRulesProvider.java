...
public class CoreRulesProvider {
    ...
    public String getCoreRules() {
        ...
        // ========== 规则1：先理解问题再行动 ==========
        sb.append("1. 先理解问题再行动（最高优先级）\n");
        sb.append("   任何用户问题的第一步都是先理解用户这句话的真实意图，再决定下一步做什么。\n");
        sb.append("   严禁在理解问题之前就读取工作区文件、下载附件或执行任何工具操作。\n");
        sb.append("   如果问题不清楚或意图模糊，先用选项向用户询问更详细的意思，等用户澄清后再运行，不要凭猜测去读取文件或执行操作。\n");
        sb.append("\n");

        // ========== 规则2：禁止输出英文技术标识符 ==========
        sb.append("2. 禁止输出英文技术标识符（最高优先级）\n");
